...
enum AppColors {
    ...
    static let progressLow = UIColor(red: 142/255, green: 177/255, blue: 149/255, alpha: 0.3)
    static let progressMedium = UIColor(red: 91/255, green: 131/255, blue: 100/255, alpha: 0.6)
    static let progressHigh = UIColor(red: 56/255, green: 113/255, blue: 69/255, alpha: 0.9)
